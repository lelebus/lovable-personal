            ...
            <div className="absolute -bottom-10 -left-10 sophisticated-card p-10 rounded-3xl shadow-sophisticated-premium backdrop-blur-premium animate-float border-2 border-accent/20">
              <div className="flex items-center gap-6">
                <div className="relative">
                  <div className="w-5 h-5 tech-gradient rounded-full animate-glow-pulse shadow-accent-glow" />
                  <div className="absolute inset-0 w-5 h-5 tech-gradient rounded-full animate-ping opacity-30" />
